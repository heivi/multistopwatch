...
function renderDeletedStopwatches() {
	...
	if (deletedStopwatches.length > 0) {
		...
		deletedStopwatches.forEach(stopwatch => {
			...
			const stopwatchHtml = `
                <div>
                    ...
                    <button class="btn btn-success recover-btn" data-id="${stopwatch.id}">Recover</button>
                </div>
            `;
		...
		container.append('<button id="clearDeletedBtn" class="btn btn-danger">Clear Deleted Stopwatches</button>');
	} else {
...
function renderStopwatch(stopwatch) {
	const stopwatchHtml = `
        <div id="stopwatch-${stopwatch.id}" class="stopwatch-container">
            ...
            <button class="btn btn-success start-btn" data-id="${stopwatch.id}">Start</button>
            <button class="btn btn-warning stop-btn" data-id="${stopwatch.id}">Stop</button>
            <button class="btn btn-secondary lap-btn" data-id="${stopwatch.id}">Lap</button>
            <button class="btn btn-danger reset-btn" data-id="${stopwatch.id}">Reset</button>
            <button class="btn btn-danger remove-btn" data-id="${stopwatch.id}">Remove</button>
			<button class="btn btn-info journal-btn" data-id="${stopwatch.id}">Journal</button>
			<ul class="list-group journal-list" style="display:none" id="#journal-list-${stopwatch.id}" data-id="${stopwatch.id}"></ul>
        </div>
    `;
